...
function hasVisitsDay(string $dt) : bool{
	return checkVisitName($dt) && file_exists("core/visits/$dt");
}

function getVisitsDays() : array{
	$files = scandir("core/visits");

	return array_filter($files, function($file){
		return is_file("core/visits/$file") && checkVisitName($file);
	});
}
...
function addVisitLog() : bool{
	...
	file_put_contents("core/visits/$logName.txt", $log, FILE_APPEND);
	return true;
}
